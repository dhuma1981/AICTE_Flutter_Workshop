class ApiResponse {
  ...
  ApiResponse({this.success, this.data, this.lastRefreshed, this.lastOriginUpdate});
...
class Data {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.unofficialSummary != null) {
      data['unofficial-summary'] = this.unofficialSummary!.map((v) => v.toJson()).toList();
    }
...
class Summary {
  ...
  Map<String, dynamic> toJson() {
    ...
    data['confirmedButLocationUnidentified'] = this.confirmedButLocationUnidentified;
    return data;
  }
}
...
class UnofficialSummary {
  ...
  UnofficialSummary({this.source, this.total, this.recovered, this.deaths, this.active});
